...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    JComboBox comboid;
    JTextField tfnumber,tfname,tfcountry,tfgender,tfdeposit;
    ...
    getContentPane().setBackground(Color.WHITE);
        ...
        JLabel lnid=new JLabel("ID");
        lnid.setBounds(35,80,100,20);
        lnid.setFont(new Font("Raleway",Font.PLAIN,20));
        add(lnid);
